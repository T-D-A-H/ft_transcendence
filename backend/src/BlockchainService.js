...
class BlockchainService {
	...
	const artifactPath = path.join(
		__dirname,
		"../../database/blokchain/artifacts/contracts/TournamentScores.sol/TournamentScores.json"
	);

	if (!fs.existsSync(artifactPath)) {
		throw new Error(
		"Contract artifact not found. Please compile the contract first with: cd database/blokchain && npx hardhat compile"
		);
	}
