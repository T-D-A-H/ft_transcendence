...
async function startServer() {
  ...
  fastify.post(
    "/api/login",
    loginHandler(db, bcrypt, userManager, fastify, setTokenCookie),
  );
  ...
  fastify.post(
    "/api/verify-2fa",
    verify2FAhandle(userManager, fastify, setTokenCookie),
  );
  ...
  fastify.get(
    ...
    googleCallback(userManager, fastify, db, setTokenCookie),
  );
