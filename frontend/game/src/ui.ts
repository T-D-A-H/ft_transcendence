...
// MENU 2FA
export const twoFAOptionModal = document.getElementById(
  "twofa_option_modal"
) as HTMLDivElement;

// Via email
export const twoFAEmailButton = document.getElementById(
  "twofa_email_button"
) as HTMLInputElement;
export const twoFAModal = document.getElementById(
  "twofa_modal"
) as HTMLDivElement;
export const twoFAInput = document.getElementById(
  "twofa_input"
) as HTMLInputElement;
export const twoFASubmitButton = document.getElementById(
  "twofa_submit_button"
) as HTMLButtonElement;

// Skip
export const twoFASkipButton = document.getElementById(
  "twofa_skip_button"
) as HTMLButtonElement;

// VIA AUTH
export const twoFAAuthButton = document.getElementById(
  "twofa_auth_button"
) as HTMLButtonElement;

// LOADER
export const initialLoader = document.getElementById(
  "initial_loader"
) as HTMLDivElement;
...
export const themeOptions = // Theme option elements
  document.querySelectorAll(".theme-option") as NodeListOf<HTMLDivElement>;
