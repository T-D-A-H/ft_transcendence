...
export const topBarOpponentButton = document.getElementById(
  "opponent_profile_button",
) as HTMLDivElement;

export const topBarOpponentPicture = document.getElementById(
  "opponent_profile_image",
) as HTMLDivElement;

export const topBarOpponentDisplayName = document.getElementById(
...
export const openMenuButton = document.getElementById(
  "menu_button",
) as HTMLButtonElement;

export const topBarProfilePicture = document.getElementById(
  "self_profile_image",
) as HTMLDivElement;

export const topBarDisplayName = document.getElementById(
  "self_displayname",
) as HTMLSpanElement;

export const menuModal = document.getElementById(
  "menu_modal",
) as HTMLDivElement;

export const menuDisplayName = document.getElementById(
  "profile_displayname",
) as HTMLDivElement;

export const menuUsername = document.getElementById(
  "profile_username",
) as HTMLDivElement;

export const menuButtons = document.querySelectorAll<HTMLButtonElement>(
  ".pong-menu-buttons .pong-button",
);
...
export const playLocallyButton = document.getElementById(
  "play_locally",
) as HTMLButtonElement;

export const playAgainstAIButton = document.getElementById(
  "play_ai",
) as HTMLButtonElement;

export const playAgainstUserButton = document.getElementById(
  "play_against_user",
) as HTMLButtonElement;

export const playRequestModal = document.getElementById(
  "play_request_modal",
) as HTMLDivElement;

export const playRequestUsernameInput = document.getElementById(
  "play_request_username",
) as HTMLInputElement;

export const playRequestCloseButton = document.getElementById(
  "close_play_request",
) as HTMLButtonElement;

export const playRequestSendButton = document.getElementById(
  "send_play_request",
) as HTMLButtonElement;
...
export const incomingPlayRequestModal = document.getElementById(
  "incoming_play_request_modal",
) as HTMLDivElement;

export const incomingPlayRequestText = document.getElementById(
  "incoming_play_request_text",
) as HTMLParagraphElement;

export const incomingPlayRequestCloseButton = document.getElementById(
  "incoming_play_request_close",
) as HTMLButtonElement;

export const incomingPlayRequestAcceptButton = document.getElementById(
  "incoming_play_request_accept",
) as HTMLButtonElement;
...
export const closeCreateTournamentButton = document.getElementById(
  "tournament_create_cancel_button",
) as HTMLButtonElement;

export const submitTournamentCreationButton = // Submit Tournament creation button
  document.getElementById(
    "tournament_create_submit_button",
  ) as HTMLButtonElement;

export const createTournamentModal = document.getElementById(
  "create_tournament_modal",
) as HTMLDivElement;

export const aliasTournamentInput = document.getElementById(
  "tournament_alias",
) as HTMLInputElement;

export const tournamentSizeInput = document.getElementById(
  "tournament_size",
) as HTMLInputElement;

const input = document.getElementById("tournament_size") as HTMLInputElement;
...
// VIA AUTH
export const googleLoginButton = document.getElementById(
  "google_login",
) as HTMLButtonElement;

export const closeSearchTournamentButton = document.getElementById(
  "tournament_search_cancel_button",
) as HTMLButtonElement;
...
export const notificationBox = document.getElementById(
  "notify-box",
) as HTMLDivElement;

export const notificationBoxText = document.getElementById(
  "notify-text",
) as HTMLDivElement;

export const notificationAcceptButton = document.getElementById(
  "notify-accept",
) as HTMLButtonElement;
...
const changeProfilePicButton = document.getElementById(
  "change_profilepic_button",
) as HTMLButtonElement;

const profilePicModal = document.getElementById(
  "profilepic_modal",
) as HTMLDivElement;

const profilePicGrid = document.getElementById(
  "profilepic_grid",
) as HTMLDivElement;

const profilePicCancelButton = document.getElementById(
  "profilepic_cancel_button",
) as HTMLButtonElement;

const selfProfileImage = document.getElementById(
  "self_profile_image",
) as HTMLDivElement;
